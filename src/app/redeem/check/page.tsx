...
export default function RedeemCheckPage() {
  ...
  const lastUsedStr = result?.lastUsedAt
    ? new Date(result.lastUsedAt).toLocaleDateString("zh-TW", { year: "numeric", month: "long", day: "numeric", hour: "2-digit", minute: "2-digit" })
    : null;
      ...
      <section className="mx-auto w-full max-w-lg py-10 sm:py-14">
        ...
        <div className="mt-7 flex flex-col gap-3 sm:flex-row">
          <input
            ...
            onKeyDown={(e) => e.key === "Enter" && !loading && void handleCheck()}
        ...
        {result && (
          <div className="mt-6 rounded-2xl border border-[#d8bd70]/25 bg-midnight/50 p-5 sm:p-6">
            <div className="flex flex-wrap items-start justify-between gap-2">
              <div>
                <p className="font-mono text-xl font-bold tracking-[0.16em] text-[#d8bd70]">
                  {result.code}
                </p>
